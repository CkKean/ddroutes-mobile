...
class NotPickUpForm extends StatefulWidget {
  ...
  @override
  _NotPickUpFormState createState() => _NotPickUpFormState();
}

class _NotPickUpFormState extends State<NotPickUpForm> {
  final _formKey = GlobalKey<FormState>();

  DateTime arrivedAt;
  static TextEditingController reasonSelectController = TextEditingController();
  ...
  void submitForm() async {
    if (_formKey.currentState.validate()) {
      TaskProofModel taskProof = new TaskProofModel(
          ...
          status: TaskProofStatus.NOT_PICK_UP,
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Text("Proof of Pickup (POP)"),
        ),
        body: SafeArea(
          top: false,
          bottom: false,
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      DropdownButtonFormField<String>(
                        ...
                        items: NotDeliveredReasonConstant.pickReasonList
                            .map((value) {
